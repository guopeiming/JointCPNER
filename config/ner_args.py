...
def parse_args() -> argparse.Namespace:
    ...
    # [Data]
    parser.add_argument('--input', type=str, default='./data/onto/temp/', help='path of input data')
    ...
    # [Model]
    parser.add_argument('--name', default='NERBERTCRF', choices=['NERBERTCRF', 'NERSLModel', 'NERSpanModel'], type=str, help='name of model')
    # [Model-sequence labeling]
    parser.add_argument('--bert_path', default='/home/data/embedding/bert-base-chinese/', type=str, help='path of BERT')  # /home/data/embedding/bert-base-cased/ /home/data/embedding/bert-base-chinese/
