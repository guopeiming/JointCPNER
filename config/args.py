...
def parse_args() -> argparse.Namespace:
    ...
    # [Data]
    parser.add_argument('--input', type=str, default='./data/onto/parsing/', help='path of input data')
    ...
    parser.add_argument('--epoch', default=20, type=int, help='max training epoch')
