...
def parse_args() -> argparse.Namespace:
    ...
    # [Data]
    parser.add_argument('--input', dest='input', type=str, default='./data/CTB5/', help='path of input data')
    ...
    parser.add_argument('--epoch', default=30, type=int, help='max training epoch')
