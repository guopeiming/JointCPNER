...
def parse_args() -> argparse.Namespace:
    ...
    # [Data]
    parser.add_argument('--joint_input', type=str, default='./data/onto/joint_word_pos/', help='path of input data')
    parser.add_argument('--parsing_input', type=str, default='./data/onto/parsing_word_pos/', help='path of input data')
    ...
    # [Loss]
    parser.add_argument('--lambda_scaler', default=0.3, type=float, help='parsing and ner loss scaler')
    parser.add_argument('--alpha_scaler', default=0.1, type=float, help='parsing and ner loss scaler')
