...
def parse_args() -> argparse.Namespace:
    ...
    # [Data]
    parser.add_argument('--joint_input', type=str, default='./data/onto/joint_en/', help='path of input data')
    parser.add_argument('--parsing_input', type=str, default='./data/onto/parsing_en/', help='path of input data')
